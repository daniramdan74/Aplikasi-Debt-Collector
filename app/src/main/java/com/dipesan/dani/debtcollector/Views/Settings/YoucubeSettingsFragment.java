...
import com.dipesan.dani.debtcollector.services.UIUtils;
 ...
 */
public class YoucubeSettingsFragment extends Fragment {

    private static final String TAG = "YoucubeSetting";
    ...
    public YoucubeSettingsFragment() {
        // Required empty public constructor
    }

    public static YoucubeSettingsFragment newInstance() {
        YoucubeSettingsFragment fragment = new YoucubeSettingsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_youcube_settings, container, false);
    ...
    @OnClick({R.id.settings_device_edit_text, R.id.settings_save_button})
