 ...
 */
package com.dipesan.dani.debtcollector.services;
 ...
 */
public class AuthorizationTask implements IAuthorizationTask, DialogInterface.OnClickListener {
    ...
    public void execute(ITaskMonitor monitor) {
        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                builder.setPositiveButton("Approved", AuthorizationTask.this);
                builder.setNegativeButton("Declined", AuthorizationTask.this);

                //builder.setNeutralButton("Unable to go online", AuthorizationTask.this);
