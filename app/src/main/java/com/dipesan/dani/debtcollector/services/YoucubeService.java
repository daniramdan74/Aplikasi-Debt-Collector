...
import com.dipesan.dani.debtcollector.Utils.ucube.CardReaderType;
import com.dipesan.dani.debtcollector.Utils.ucube.TransactionType;
                                        ...
                                        builder.setPositiveButton("Setting",
                                                new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        dialog.dismiss();
                                                        Intent intent = new Intent(activity, MainDetailsActivity.class);
                                                        intent.putExtra(MENU, MENU_YOUCUBE_SETTINGS);
